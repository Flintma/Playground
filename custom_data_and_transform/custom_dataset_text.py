...
###################################################################
###data structure -- flickr8k caption dataset
#1. images in one folder
#2. .txt file(2 columns) --1 column: img name  --2 column: captions
# every img has 5 captions(each in seperate row)
###################################################################

#Goal
#1. convert text -> numerical values
#2. need a Vocabulary mapping each word to a index
...
class FlickrDataset(Dataset):
    ...
    def __getitem__(self,index):
        ...
        numericalized_caption += self.vocab.numericalize(captions)
